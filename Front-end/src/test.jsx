...
function App() {
  ...
  useEffect(() => {
    ...
    // pour mettre à jour l'utilisateur dans le state
  ...
  // Remplacez ceci par un appel API réel pour récupérer les recommandations
  // ou utilisez Supabase pour récupérer les données
          ...
          <>
            {filteredRecommendations.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-gray-600 text-lg">Aucune recommandation trouvée</p>
              </div>
            ) : (
